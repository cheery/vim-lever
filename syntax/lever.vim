...
syn keyword leverKeyword if elif else while import from return yield for in as break continue raise try except finally and or not assert class extends
